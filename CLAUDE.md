...
Project memory for Claude Code. Scope: the whole repository.

The complete human-facing development charter is in `docs/development-charter.zh-CN.md`. Keep this file short, current, and aligned with `AGENTS.md`.
